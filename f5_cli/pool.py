...
class Pool:
    ...
    def create(self, parser):
        ...
        self.parser.add_argument(
            '--pool_name', action='store', dest='pool_name', required=True, help='Name of the pool')
        self.parser.add_argument(
            '--nodes', action='store', dest='nodes', required=True, help='Comma seperated list of nodes')
        ...
        for x in nodes.split(','):
            ...
            try:
                ...
                raise Exception(
                    "{} did not have a valid A record, please add one and try again".format(pool_member['name']))
    ...
    def __create(self, pool_name, pool_member_list, username):
        ...
        try:
            ...
            self.connection.LocalLB.Pool.set_description(
    ...
    def delete(self, parser):
        ...
        """
        self.parser.add_argument(
            '--pool_name', action='store', dest='pool_name', required=True, help='Name of the pool to delete')
        args = self.parser.parse_args()
